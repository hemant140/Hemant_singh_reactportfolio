            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
                ...
                <div className='flex justify-center'>
                    ...
                    <div className='flex-1'>
                        ...
                        <div>
                            <a href="Hemant_Singh_Junior_Software_Developer.pdf" target='_blank' ><button className="text-white font-bold bg-teal-500 w-fit px-4 py-2 my-2 rounded-md max-sm:px-3 max-sm:py-2 hover:scale-110 duration-300 cursor-pointer">
                                Resume
                            </button></a>
                        </div>
