...
const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    description: 'Powering millions of conversations',
    color: '#a855f7',
  },
  {
    icon: FiCloud,
    ...
    description: 'Multi-tenant architectures',
    color: '#06b6d4',
  },
  {
    icon: FiHome,
    ...
    description: 'Managed on Bluearn PMS',
    color: '#f97316',
  },
  {
    icon: FiActivity,
    ...
    description: 'Carbon emission tracking',
    color: '#22c55e',
  },
  {
    icon: FiCalendar,
    ...
    description: 'Through Dayzio platform',
    color: '#ec4899',
  },
  {
    icon: FiGlobe,
