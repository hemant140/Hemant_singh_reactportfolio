...
const Projectscard = ({ title, des, src, href, showGlobeLink, showBookLink, showEsimSouceLink, showahbrndsLink, projectLink, projectUrl }) => {
    return (
        <div className="w-full p-4 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:gray-900 transition-colors duration-1000 hover:scale-105">
                        ...
                        <div className="flex gap-2">
                            {href && (
                                <a href={href} target='_blank' rel="noopener noreferrer">
                                    <span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-hemant group-hover:text-white duration-300 cursor-pointer">
                                        <BsGithub />
                                    </span>
                                </a>
                            )}
                            ...
                            {projectLink && (
                                <a href={projectUrl} target='_blank' rel="noopener noreferrer"><span className="text-lg w-10 h-10 rounded-full bg-black inline-flex justify-center items-center text-hemant group-hover:text-white duration-300 cursor-pointer">
                                    <FaGlobe />
                                </span></a>
                            )}
                            {showGlobeLink && (
